...
<#list courseInfo as courseInfo>
    ...
    <#else></#if>
    <#assign studentWorkUrl = "https://vault.cca.edu/access/searching.do?doc=%3Cxml%3E%3Clocal%3E%3CcourseWorkWrapper%3E%3CcourseWorkType%3ECourse+work%3C%2FcourseWorkType%3E%3C%2FcourseWorkWrapper%3E%3CcourseInfo%3E%3Ccourseinfo%3E${courseinfo}%3C%2Fcourseinfo%3E%3C%2FcourseInfo%3E%3Cdepartment%3EWriting+and+Literature%3C%2Fdepartment%3E%3C%2Flocal%3E%3C%2Fxml%3E&in=Pe78fd93a-86cd-40a9-9382-e86897646a2d&q=&sort=datemodified&dr=AFTER" />
...
<#list assignmentWrapper as assignmentWrapper>
    ...
    <#assign genEdLO = xml.getAllSubtrees('local/programLearningOutcomes')>
    ...
    <#list local as local>
        ...
        <#if genEdLOx==""><#else>
            <dd><strong>GenEd Learning Outcomes:</strong></dd>
                <dd>
                <#list genEdLO as genEdLO>&bull; ${genEdLO}<#if genEdLO_has_next><br/></#if>
                </#list>
                </dd>
            </#if>
