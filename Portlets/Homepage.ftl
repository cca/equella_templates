...
<div id = "mainPageBox">
        <div id = "mainTabs">
            ...
            <div data-target = "#campusPlanning" class = "mainTab" id = "campBtn">Campus Planning: Spatial Benchmarking</div>
                        ...
                        <!-- <div data-target = "#studentCollections" class = "mainTab active">Student Collections</div> -->
        </div>
