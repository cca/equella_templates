...
<#if !userIsMemberOf('Staff') && !userIsMemberOf('Faculty') && !userIsMemberOf('Student') && !userIsMemberOf('Students') && !userIsMemberOf('students') && !userIsMemberOf('System Administrators')>
<style>
#breadcrumbs,
#menu,
#col2,
