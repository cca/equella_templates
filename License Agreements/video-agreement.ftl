...
<div class="control alert no-print clearfix">
    <ul class="standard">
        ...
        <li><b>Upload</b> the signed copy <a href="#p2c3">at the bottom of this form</a></li>
...
<p>Content is to be used for the purpose of producing, distributing and exploiting video release of the documentary currently entitled ${title} ("Documentary") by Publisher.</p>
<p>In connection with advertising, publicizing, exhibiting and exploiting the Documentary, Content may be used in whole or in part in any and all media, devices, processes and technology now known or hereafter devised except as restricted in Section IV.</p>

<h2><u>IV. Specific Restrictions on Use of Content</u></h2>
<p>Use of Content in Media outside of the Documentary. Publisher shall not use the Content for media-based, electronic, online, or other such non-print versions of the Documentary without the prior written permission of Owner.</p>
<p>Use of the Content in electronic form for the purpose of advertising, publicizing, exhibiting and exploiting the Documentary must be in the form of derivatives created by the Publisher such that the resolution of the Content is no greater than 72 ppi with maximum image dimensions of 1000 pixels x 800 pixels.</p>
...
<h2><u>VI. Term</u></h2>
<p>This Agreement shall continue in effect for the duration of time after the Effective Date as designated by Publisher.</p>

<h2><u>VII. Owner Obligations</u></h2>
<p>Owner acknowledges that Publisher is proceeding with the production, distribution, and exploitation of the Documentary in reliance upon and induced by the Agreement and therefore will not revoke it or attempt to enjoin or otherwise interfere with the same.</p>

<h2><u>VIII. Publisher Obligations</u></h2>
<p>Publisher shall have the right but not the obligation to utilize the Content in the Documentary, and in advertising, publicizing, exhibiting, or exploiting same, in whole or in part.</p>
<p>When the agreement is terminated, Publisher must destroy the Content as originally delivered by Owner, along with any derivatives created in the process of realizing the Documentary and associated advertising, publicity, etc.</p>
...
<p>Except as specifically stated in this agreement, parties may not assign, directly or indirectly, all or part of its rights or obligations under this Agreement without the prior written consent of the
other party, which consent shall not be unreasonably withheld or delayed. The right to renegotiate terms is reserved if the nature of the assignee is substantially different.</p>
...
<p><u>Mediation</u>. In the event that the parties cannot by exercise of their best efforts resolve the dispute, they shall submit the dispute to Mediation. The parties shall, without delay, continue to perform their respective obligations under this Agreement, which are not affected by the dispute. The invoking party shall give to the other party written notice of its decision to do so, including a description of the issues subject to the dispute and a proposed resolution thereof. Designated representatives of both parties shall attempt to resolve the dispute within 90 days after such notice. If those designated representatives cannot resolve the dispute, the parties shall meet in or near San Francisco, California, and describe the dispute and their respective proposals for resolution to responsible executives of the disputing parties, who shall act in good faith to resolve the dispute. If the dispute is not resolved within 90 days after such meeting, the dispute shall be submitted to binding arbitration in accordance with the Arbitration provision of this Agreement.</p>
