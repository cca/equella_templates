...
<#list local as local>
    ...
    <#if (divisions?size > 0)>
        ...
        <#list divisions as division>
            <#if division != "">
            <#assign divisionUrl = "/access/searching.do?doc=%3Cxml%3E%3Clocal%3E%3CcommunicationsWrapper%3E%3CdepictedWrapper%2F%3E%3C%2FcommunicationsWrapper%3E%3Cdivision%3E${division}%3C%2Fdivision%3E%3C%2Flocal%3E%3C%2Fxml%3E&in=P04c5d28c-713c-37fe-5e33-6c0ee78651f0&q=&dr=AFTER">
...
<#list itemAttachments as itemAttachment>
    ...
    <div class="image-photoSeniorPacket">
        ...
        <#if (size?has_content && size?number > 10000000)>
            <#-- Masonry layout needs width/height attrs to know how to rearrange
            rel lets the fancybox group the images together
            onclick attr is how EQUELLA does its pop-ups -->
            <a rel="comm-images" href="${imgUrl}" onclick="popup('/items/${itemUuid}/${itemversion}/${full}?.vi=toimg',null,'80%','80%');return false;" class="largeFile"><img src="${thumbUrl}" width="88" height="66"/></a>
        <#else>
            <a rel="comm-images" href="${imgUrl}"><img src="${thumbUrl}" width="88" height="66"/></a>
        </#if>
        ...
        <#list communications as communications>
            ...
            <#if file == uuid>
                <#list communications.getAllSubtrees('depictedWrapper') as depicted>
                    ...
                    <#assign depictedDeptUrl = "/access/searching.do?doc=%3Cxml%3E%3Clocal%3E%3CcommunicationsWrapper%3E%3CdepictedWrapper%3E%3CdepictedDept%3E${depictedDept}%3C%2FdepictedDept%3E%3C%2FdepictedWrapper%3E%3C%2FcommunicationsWrapper%3E%3C%2Flocal%3E%3C%2Fxml%3E&in=P04c5d28c-713c-37fe-5e33-6c0ee78651f0&q=&dr=AFTER">
...
<#list name as name>
    ...
    <#if namePart == ""><dd>Unknown photographer</dd><#else>
        <#assign nameUrl = "/access/searching.do?doc=%3Cxml%3E%3Cmods%3E%3Cname%3E%3CnamePart%3E${namePart}%3C%2FnamePart%3E%3C%2Fname%3E%3C%2Fmods%3E%3C%2Fxml%3E&in=P04c5d28c-713c-37fe-5e33-6c0ee78651f0&q=&dr=AFTER">
...
<#list relateditem as relateditem>
    ...
    <#assign titleUrl = '/access/searching.do?doc=%3Cxml%3E%3Cmods%3E%3Crelateditem%3E%3Ctitle%3E${title}%3C%2Ftitle%3E%3C%2Frelateditem%3E%3C%2Fmods%3E%3C%2Fxml%3E&in=P04c5d28c-713c-37fe-5e33-6c0ee78651f0&q=&dr=AFTER'>
    <#if title != "">
