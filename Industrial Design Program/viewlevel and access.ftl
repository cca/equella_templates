...
<#list modslevel as mods>
    <#assign accessCondition = mods.get('accessCondition')>
        ...
        For rights relating to this resource, contact the <a href="mailto:industrialdesign@cca.edu?Subject=Inquiry%20about%20Vault%20images" target="_top">${accessCondition}</a>.</br>
