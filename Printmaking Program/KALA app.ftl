...
<#list courseWork as courseWork>
    ...
    <dl>
        ...
        <#-- this is the sole difference between KALA App & Senior Packet displays:
        KALA App has letter of intent, Senior Packet has Showcard File -->
        <#list xml.getAllSubtrees('local/exhibitWrapper/showcardFile') as letterOfIntent>
            <#list itemAttachments as itemAttachment>
                <#if letterOfIntent.get('/') = itemAttachment.get('uuid')>
