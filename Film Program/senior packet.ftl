...
<#list courseWork as courseWork>
    ...
    <dl>
        ...
        <#if division != "">
            ...
            <#assign departmentUrl = "/access/searching.do?in=C3c29d46d-73c0-4144-8f2b-7470d5f59134&q=&type=standard&sort=rank&dr=AFTER" />
        ...
        <#list itemAttachments as itemAttachment>
            ...
            <#list seniorPacket as seniorPacket>
                ...
                <#assign synopsis = seniorPacket.get('phase')>
                ...
                <div class='image-with-metadata'>
                    ...
                    <#if categories?size != 0>
                        ...
                        <#list categories as category>
                            ...
                            <#-- note: we don't currently offer an "other..."
                            write-in but I'm leaving this here if we decide to add
                            <#else>
