...
<#assign courseWorkType = courseWork.get('courseWorkType')>
    ...
    <dl>
        ...
        <#if division != "">
            ...
            <#assign departmentUrl = "/access/searching.do?in=Cec35246f-c348-403d-88ea-332ad1916042&q=&type=standard&dr=AFTER">
        ...
        <#list attachments as attachment>
            ...
            <#list xml.getAllSubtrees('local/seniorPacketWrapper') as seniorPacket>
                ...
                <#-- formatOther is the "other..." write-in for formatBroad -->
                <#assign formatOther = seniorPacket.get('formatOther')>
                <#-- Glass uses all three of these -->
                ...
                <#-- neither file attachment control is mandatory
                so prefer lo res if available, fall back to hi res -->
                <#assign lowRes = seniorPacket.get('lowResFile')>
                <#assign hiRes = seniorPacket.get('hiResFile')>
                <#if lowRes != "">
                    <#assign file = lowRes>
                <#else>
                    <#assign file = hiRes>
                ...
                <div class="image-with-metadata">
                    ...
                    <b>Dimensions:</b>&nbsp;${heightINCH} x ${widthINCH} x ${depthINCH}
                    </p>
                </div>
